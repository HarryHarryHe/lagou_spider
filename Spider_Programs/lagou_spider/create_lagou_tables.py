...
# 创建数据库的连接
engine = create_engine("mysql+pymysql://root:19990428@127.0.0.1:3306/lagou?charset=utf8")
...
class Lagoutables(Base):
    ...
    # 岗位性质
    jobNature = Column(String(length=20), nullable=False)
    # 公司类型
    financeStage = Column(String(length=20), nullable=True)
    # 公司规模
